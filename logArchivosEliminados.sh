...
diff -u $archivos_hoy $archivos_ayer > archivos_eliminados.log

# Mostramos el resultado de los archivos eliminados
echo "Archivos eliminados:"
grep "^-" archivos_eliminados.log | cut -c 3-

# Eliminamos los archivos temporales
rm $archivos_hoy $archivos_ayer

echo "Finalizado, los archivos eliminados han sido puestos en archivos_eliminados.log"
