...
public class Main {
    public static void main(String[] args) throws InterruptedException {
        ...
        Proceso p1 = new Proceso("1111",1,1,recursos, Proceso.Estados.Listo);
        Proceso p2 = new Proceso("1112",212,2,recursos, Proceso.Estados.Listo);
        Proceso p3 = new Proceso("1113",33,3,recursos, Proceso.Estados.Listo);
