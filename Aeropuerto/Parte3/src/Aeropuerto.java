...
public class Aeropuerto extends Thread implements Runnable {
    ...
    /*
        public synchronized void pedirPermisoParaUsarPistas() throws InterruptedException {
            //  this.pista0624.usar.acquire();
            this.pista0119.usar.acquire();
        }

        public synchronized void devolverPermisoParaUsarPistas() throws InterruptedException {
            this.pista0119.usar.release();
            //this.pista0624.usar.release();
        }
    */
    public void bloquear(Avion avion) {
