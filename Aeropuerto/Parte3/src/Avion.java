...
public class Avion extends Thread implements Comparable<Avion>, Runnable {
    ...
    public Semaphore rec;


    public Avion(Aeropuerto aeropuerto, int prioridad, String nombre, int nivelCombustible, Estados estado, int x, int y, ImageIcon icono, Semaphore semaforo, Semaphore r) {
...
*/
        ...
        // aeropuerto.pedirPermisoParaUsarPistas();
        //aeropuerto.pistaActiva.bloquear();
        System.out.println("Thread actual: " + Thread.currentThread().getName());
        //aeropuerto.pistaActiva.lock.lock();
    ...
    public void taxear19Porton() throws InterruptedException {
        //salgo de la pista
        //aeropuerto.pistaActiva.desbloquear();
        //aeropuerto.pistaActiva.lock.unlock();
        //aeropuerto.setPistaOcupada(false);
        //this.notifyAll();
        devolverPermisoUsarPista();
    ...
    public void despegar19() throws InterruptedException {
        //aeropuerto.pistaActiva.usar.acquire();
        //while (!aeropuerto.pistaActiva.usar.tryAcquire()) ;
        //aeropuerto.pistaActiva.bloquear();
        //aeropuerto.pistaActiva.lock.lock();
        pedirPermisoParaUsarPista();
        System.out.println(this.nombre + " esta despegando por la pista 19");
    }
    ...
    public void run() {
        ...
        System.out.println("Thread actual avion: " + Thread.currentThread().getName());
...
/*
    ...
    private void devolverPermisoUsarPista() {
        /*
        aeropuerto.setPistaOcupada(false);
        //Thread t = aeropuerto.threads.get(this.nombre);
        //System.out.println("Thread: " + t.getName());
        for (Thread th : aeropuerto.threads.values()) {
            synchronized (th) {
                th.notify();
                System.out.println("THREAD NOTIFICADO: " + th.getName());
            }
        }*/
        //t.notify();
        //aeropuerto.tg.notify();
        //this.getThreadGroup().notifyAll();
        //t.getThreadGroup().notifyAll();
        //aeropuerto.pistaActiva.usar.release();
